...
public class AddSubject extends DriverDB implements Initializable {
    @FXML
    private JFXTextField nazwap;
...
//        });
    ...
    public void addT(MouseEvent event) throws ClassNotFoundException, UnsupportedLookAndFeelException, InstantiationException, IllegalAccessException, SQLException {
        if ((nazwap.getText() != null && !nazwap.getText().isEmpty())) {
            ...
            String quest = "INSERT INTO Przedmioty (NAZWA, NAUCZYCIELE_ID_NAUCZYCIELA) VALUES ('" + nazwap.getText() + "','" + teacher + "')";
            try {
            ...
            alert.setHeaderText("Dodano przedmiot!");
            alert.setContentText("Pomyślne dodano: " + nazwap.getText());
